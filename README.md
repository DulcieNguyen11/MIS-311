**1. Data overview**
---
This dataset can be collected from a company’s Human Resource Management System (HRMS), which stores employee information for performance and workforce analysis.It contains 204 rows and 12 columns. Each row represents a record. Each column represents a variable, including ID, Name, Age, Gender, Department, Salary, Joining date, Performance Score, Experience, Status, Location, Session. It includes data from 199 employees.
